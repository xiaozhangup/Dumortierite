...
public abstract class CraftOperationMachineBase extends SlimefunItem implements InventoryBlock, EnergyNetComponent, MachineProcessHolder<CraftingOperation> {

    private static final int[] BORDER = {0, 1, 2, 3, 4, 5, 6, 7, 8, 13, 31, 36, 37, 38, 39, 40, 41, 42, 43, 44};
    private static final int[] BORDER_IN = {9, 10, 11, 12, 18, 21, 27, 28, 29, 30};
    private static final int[] BORDER_OUT = {14, 15, 16, 17, 23, 26, 32, 33, 34, 35};

    private static final int SLOT_INDICATOR = 22;
    ...
    protected CraftOperationMachineBase(ItemGroup itemGroup, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe) {
     ...
     * {@link CraftOperationMachineBase} that has been opened by a Player.
     * <p>
     * Override this method to set the title.
     *
     * @return The title of the {@link Inventory} of this {@link CraftOperationMachineBase}
     */
    @Nonnull
    ...
    /**
     * This method returns the {@link ItemStack} that this {@link CraftOperationMachineBase} will
     ...
     * @return This method will return the current instance of {@link CraftOperationMachineBase}, so that can be chained.
     */
    public final CraftOperationMachineBase setCapacity(int capacity) {
     ...
     * @return This method will return the current instance of {@link CraftOperationMachineBase}, so that can be chained.
     */
    public final CraftOperationMachineBase setProcessingSpeed(int speed) {
     ...
     * @return This method will return the current instance of {@link CraftOperationMachineBase}, so that can be chained.
     */
    public final CraftOperationMachineBase setEnergyConsumption(int energyConsumption) {
    ...
    /**
     * This method returns an internal identifier that is used to identify this {@link CraftOperationMachineBase}
     * and its recipes.
     * <p>
     * When adding recipes to an {@link CraftOperationMachineBase} we will use this identifier to
     * identify all instances of the same {@link CraftOperationMachineBase}.
    ...
    public void preRegister() {
        addItemHandler(new BlockTicker() {
            ...
            public void tick(Block b, SlimefunItem sf, SlimefunBlockData data) {
                CraftOperationMachineBase.this.tick(b);
            }
